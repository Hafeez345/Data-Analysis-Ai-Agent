...
def load_data():
    if os.path.exists(FILE_PATH):
        ...
        # Convert Salary and Rank to numeric just in case
...
if df is not None:
    # Sidebar
    selected_q = st.sidebar.selectbox("📋 Queries you can ask:", ["Select..."] + all_questions)
    ...
    if final_query:
        # Number remove karna logic ke liye
    ...
    st.error("CSV File missing! Please place 'Ai agent 1.csv' on Desktop.")